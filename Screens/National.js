...
export const News = (props) => {
    return(
        <SafeAreaView>
            <ScrollView>
                <View>
                    {props.data.News.National.map(d => (
...
class National extends Component {
    ...
    render() {
        ...
        return (
            <Stack.Navigator>
                <Stack.Screen name="National" component={() => <Loading data ={this.props} />} />
...
export default connect(mapStateToProps , {init ,details}) (National)
...
export const News = (props) => {
    return(
        <SafeAreaView>
            <ScrollView>
                <View>
                    {props.data.News.International.map(d => (
...
class International extends Component {
    ...
    render() {
        ...
        return (
            <Stack.Navigator>
                <Stack.Screen name="International" component={() => <Loading data ={this.props} />} />
...
export default connect(mapStateToProps , {init ,details}) (International)